<template>
  <div class="ControlConfig">
    <div class="controlAttribute">
      <!--控件属性设置 start-->
      <div v-if="config" class="configSetting">
          ...
          <div v-if="index === 'CTitleCN'">
            <el-form label-position="left" label-width="70px">
              ...
              >
                ...
                ></el-input>
                <el-checkbox
                  @change="editChange('CTitleCN')"
                  v-model="attribute.CTitleCN"
                  class="edit"
                  label="不可编辑"></el-checkbox>
              </el-form-item>
            </el-form>
          </div><!--标题ended-->
          <!--英文标题start-->
          <div v-else-if="index === 'CTitleEN'">
            <el-form label-position="left" label-width="70px">
              ...
              >
                ...
                ></el-input>
                <el-checkbox
                  @change="editChange('CTitleEN')"
                  v-model="attribute.CTitleEN"
                  class="edit"
                  label="不可编辑"></el-checkbox>
              </el-form-item>
            </el-form>
          ...
          <div v-else-if="index === 'labelPositionModel'">
            <el-form label-position="top">
              ...
              >
                ...
                <el-checkbox
                  @change="editChange('labelPositionModel')"
                  v-model="attribute.labelPositionModel"
                  class="edit"
                  label="不可编辑"></el-checkbox>
              </el-form-item>
            </el-form>
          ...
          <div v-else-if="index === 'labelWidth' && config.labelPositionModel !== 'top'">
            <el-form label-position="right" label-width="70px">
              ...
              >
                ...
                ></el-input>
                <el-checkbox
                  @change="editChange('labelWidth')"
                  v-model="attribute.labelWidth"
                  class="edit"
                  label="不可编辑"></el-checkbox>
              </el-form-item>
            </el-form>
          ...
          <div v-else-if="index === 'CName'&& (item === 'CRadio' || item === 'CCheckbox' || item === 'CSelect')">
            <el-form label-position="left" label-width="70px">
              ...
              >
                ...
                <el-checkbox
                  @change="editChange('CName')"
                  v-model="attribute.CName"
                  class="edit"
                  label="不可编辑"></el-checkbox>
              </el-form-item>
              <el-dialog
              ...
              <div v-if="indexIn === 'currentValue' && config.CAttribute.typeModel === 'collapse'">
                <el-form label-position="right" label-width="70px">
                  ...
                  >
                    ...
                    ></el-input>
                    <el-checkbox
                      @change="editChange('collapseTitle')"
                      v-model="attribute.collapseTitle"
                      class="edit"
                      label="不可编辑"></el-checkbox>
                  </el-form-item>
                  <el-form-item
                  ...
                  >
                    ...
                    ></el-input>
                    <el-checkbox
                      @change="editChange('collapseContent')"
                      v-model="attribute.collapseContent"
                      class="edit"
                      label="不可编辑"></el-checkbox>
                  </el-form-item>
                </el-form>
              ...
              <div v-else-if="indexIn === 'addCollapseStatus'">
                <el-form label-position="right" label-width="70px">
                  ...
                  >
                    <el-button type="primary" @click="addItem()"><i class="el-icon-plus"></i></el-button>
                    <el-checkbox
                      @change="editChange('addCollapseStatus')"
                      v-model="attribute.addCollapseStatus"
                      class="edit"
                      label="不可编辑"></el-checkbox>
                  </el-form-item>
              ...
              <div v-else-if="indexIn === 'loadingText'">
                <el-form label-position="right" label-width="70px">
                  ...
                  >
                    ...
                    <el-checkbox
                      @change="editChange('loadingText')"
                      v-model="attribute.loadingText"
                      class="edit"
                      label="不可编辑"></el-checkbox>
                  </el-form-item>
                </el-form>
              ...
              <div v-else-if="indexIn === 'pageSmall'">
                <el-form label-position="right" label-width="154px">
                  ...
                  >
                    ...
                    <el-checkbox
                      @change="editChange('pageSmall')"
                      v-model="attribute.pageSmall"
                      class="edit"
                      label="不可编辑"></el-checkbox>
                  </el-form-item>
                </el-form>
                ...
                <div v-if="config[index].typeModel === 'pageBasic' ||
                  ...
                  <el-form label-position="right" label-width="70px">
                    ...
                    >
                      ...
                      <el-checkbox
                        @change="editChange('pageSize')"
                        v-model="attribute.pageSize"
                        class="edit"
                        label="不可编辑"></el-checkbox>
                    </el-form-item>
                  </el-form>
                ...
                <el-form label-position="right" label-width="70px">
                  ...
                  >
                    <el-input type="text" @change="changeConfig()" placeholder="当前页数"
                              v-model.number="config[index][indexIn]"></el-input>
                    <el-checkbox
                      @change="editChange('pageCurrent')"
                      v-model="attribute.pageCurrent"
                      class="edit"
                      label="不可编辑"></el-checkbox>
                  </el-form-item>
                </el-form>
                ...
                <el-form label-position="right" label-width="70px">
                  ...
                  >
                    <el-input type="text" @change="changeConfig()" placeholder="总条目数"
                              v-model.number="config[index][indexIn]"></el-input>
                    <el-checkbox
                      @change="editChange('pageTotal')"
                      v-model="attribute.pageTotal"
                      class="edit"
                      label="不可编辑"></el-checkbox>
                  </el-form-item>
                </el-form>
              ...
              <div v-else-if="indexIn === 'showAllLevels'">
                <el-form label-position="right" label-width="125px">
                  ...
                  >
                    ...
                    <el-checkbox
                      @change="editChange('showAllLevels')"
                      v-model="attribute.showAllLevels"
                      class="edit"
                      label="不可编辑"></el-checkbox>
                  </el-form-item>
                </el-form>
              ...
              <div v-else-if="indexIn === 'filterableOption'">
                <el-form label-position="right" label-width="110px">
                  ...
                  >
                    ...
                    <el-checkbox
                      @change="editChange('filterableOption')"
                      v-model="attribute.filterableOption"
                      class="edit"
                      label="不可编辑"></el-checkbox>
                  </el-form-item>
                </el-form>
              ...
              <div v-else-if="indexIn === 'changeOnSelectOption'">
                <el-form label-position="right" label-width="166px">
                  ...
                  >
                    ...
                    <el-checkbox
                      @change="editChange('changeOnSelectOption')"
                      v-model="attribute.changeOnSelectOption"
                      class="edit"
                      label="不可编辑"></el-checkbox>
                  </el-form-item>
                </el-form>
              ...
              <div v-else-if="indexIn === 'cascadeSizeOption'">
                <el-form label-position="right" label-width="70px">
                  ...
                  >
                    ...
                    <el-checkbox
                      @change="editChange('cascadeSizeOption')"
                      v-model="attribute.cascadeSizeOption"
                      class="edit"
                      label="不可编辑"></el-checkbox>
                  </el-form-item>
                </el-form>
                ...
                <el-form label-position="right" label-width="70px">
                  ...
                  >
                    <el-input @change="changeConfig()" placeholder="级联标题"
                              v-model="config[index][indexIn]"></el-input>
                    <el-checkbox
                      @change="editChange('cascadePropsTitle')"
                      v-model="attribute.cascadePropsTitle"
                      class="edit"
                      label="不可编辑"></el-checkbox>
                  </el-form-item>
                </el-form>
                ...
                <el-form label-position="right" label-width="70px">
                  ...
                  >
                    <el-input @change="changeConfig()" placeholder="控件描述(非必填)"
                              v-model="config[index][indexIn]"></el-input>
                    <el-checkbox
                      @change="editChange('cascadePlaceholder')"
                      v-model="attribute.cascadePlaceholder"
                      class="edit"
                      label="不可编辑"></el-checkbox>
                  </el-form-item>
                </el-form>
                ...
                <el-form label-position="right" label-width="70px">
                  ...
                  >
                    <el-input @change="changeConfig()" placeholder="输入框前置追加头(非必填)"
                              v-model="config[index][indexIn]"></el-input>
                    <el-checkbox
                      @change="editChange('prepend')"
                      v-model="attribute.prepend"
                      class="edit"
                      label="不可编辑"></el-checkbox>
                  </el-form-item>
                </el-form>
                ...
                <el-form label-position="right" label-width="70px">
                  ...
                  >
                    <el-input @change="changeConfig()" placeholder="输入框尾部增加(非必填)"
                              v-model="config[index][indexIn]"></el-input>
                    <el-checkbox
                      @change="editChange('append')"
                      v-model="attribute.append"
                      class="edit"
                      label="不可编辑"></el-checkbox>
                  </el-form-item>
                </el-form>
              ...
              <div v-else-if="indexIn === 'textColor' && config.CAttribute.typeModel==='button'">
                <el-form label-position="right" label-width="70px">
                  ...
                  >
                    ...
                    <el-checkbox
                      @change="editChange('textColor')"
                      v-model="attribute.textColor"
                      class="edit"
                      label="不可编辑"></el-checkbox>
                  </el-form-item>
                </el-form>
              ...
              <div v-else-if="indexIn === 'fillColor' && config.CAttribute.typeModel==='button'">
                <el-form label-position="right" label-width="70px">
                  ...
                  >
                    ...
                    <el-checkbox
                      @change="editChange('fillColor')"
                      v-model="attribute.fillColor"
                      class="edit"
                      label="不可编辑"></el-checkbox>
                  </el-form-item>
                </el-form>
              ...
              <div v-else-if="indexIn === 'currentSelected' && config[index].typeModel !== 'selectGroup'">
                <el-form
                  ...
                  <el-form-item
                    ...
                    <el-checkbox
                      @change="editChange('currentSelectedLabel')"
                      v-model="attribute.currentSelectedLabel"
                      class="edit"
                      label="不可编辑"></el-checkbox>
                  </el-form-item>
                  <el-form-item
                  ...
                  >
                    ...
                    <el-checkbox
                      @change="editChange('currentSelectedShowcontent')"
                      v-model="attribute.currentSelectedShowcontent"
                      class="edit"
                      label="不可编辑"></el-checkbox>
                  </el-form-item>
                  <el-form-item
                  ...
                  >
                    ...
                    <el-checkbox
                      @change="editChange('delete')"
                      v-model="attribute.delete"
                      class="edit"
                      label="不可编辑"></el-checkbox>
                  </el-form-item>
                  <el-form-item
                  ...
                  >
                    ...
                    <el-checkbox
                      @change="editChange('isDisabled')"
                      v-model="attribute.isDisabled"
                      class="edit"
                      label="不可编辑"></el-checkbox>
                  </el-form-item>
                </el-form>
              ...
              <div v-else-if="indexIn === 'showAllCheckbox' && config[index].typeModel !== 'button'">
                <el-form label-position="right" label-width="80px">
                  ...
                  >
                    ...
                    <el-checkbox
                      @change="editChange('showAllCheckbox')"
                      v-model="attribute.showAllCheckbox"
                      class="edit"
                      label="不可编辑"></el-checkbox>
                  </el-form-item>
                </el-form>
              ...
              <div v-else-if="indexIn === 'ableSelectedMin'">
                <el-form label-position="right" label-width="86px">
                  ...
                  >
                    ...
                    <el-checkbox
                      @change="editChange('ableSelectedMin')"
                      v-model="attribute.ableSelectedMin"
                      class="edit"
                      label="不可编辑"></el-checkbox>
                  </el-form-item>
                </el-form>
              ...
              <div
                ...
                <el-form label-position="right" label-width="86px">
                  ...
                  >
                    ...
                    <el-checkbox
                      @change="editChange('ableSelectedMax')"
                      v-model="attribute.ableSelectedMax"
                      class="edit"
                      label="不可编辑"></el-checkbox>
                  </el-form-item>
                </el-form>
              ...
              <div v-else-if="indexIn === 'currentSelectedGroup' && config[index].typeModel === 'selectGroup'">
                <el-form label-position="right" label-width="90px">
                  ...
                  >
                    ...
                    <el-checkbox
                      @change="editChange('currentSelectedGroupLabel')"
                      v-model="attribute.currentSelectedGroupLabel"
                      class="edit"
                      label="不可编辑"></el-checkbox>
                  </el-form-item>
                  <el-form-item
                  ...
                  >
                    ...
                    <el-checkbox
                      @change="editChange('currentSelectedGroupShowcontent')"
                      v-model="attribute.currentSelectedGroupShowcontent"
                      class="edit"
                      label="不可编辑"></el-checkbox>
                  </el-form-item>
                  <el-form-item
                  ...
                  >
                    ...
                    <el-checkbox
                      @change="editChange('DeleteSelectGroup')"
                      v-model="attribute.DeleteSelectGroup"
                      class="edit"
                      label="不可编辑"></el-checkbox>
                  </el-form-item>
                  <el-form-item
                  ...
                  >
                    ...
                    <el-checkbox
                      @change="editChange('isDisabledGroup')"
                      v-model="attribute.isDisabledGroup"
                      class="edit"
                      label="不可编辑"></el-checkbox>
                  </el-form-item>
                </el-form>
              ...
              <div v-else-if="indexIn === 'isMultiple'">
                <el-form label-position="right" label-width="70px">
                  ...
                  >
                    ...
                    <el-checkbox
                      @change="editChange('isMultiple')"
                      v-model="attribute.isMultiple"
                      class="edit"
                      label="不可编辑"></el-checkbox>
                  </el-form-item>
                </el-form>
              ...
              <div v-else-if="config[index].isMultiple === false && indexIn === 'isSelectClearable'">
                <el-form label-position="right" label-width="150px">
                  ...
                  >
                    ...
                    <el-checkbox
                      @change="editChange('isSelectClearable')"
                      v-model="attribute.isSelectClearable"
                      class="edit"
                      label="不可编辑"></el-checkbox>
                  </el-form-item>
                </el-form>
              ...
              <div v-else-if="indexIn === 'isSelectFilterable'">
                <el-form label-position="right" label-width="70px">
                  ...
                  >
                    ...
                    <el-checkbox
                      @change="editChange('isSelectFilterable')"
                      v-model="attribute.isSelectFilterable"
                      class="edit"
                      label="不可编辑"></el-checkbox>
                  </el-form-item>
                </el-form>
              ...
              <div v-else-if="indexIn === 'isSelectCreate'">
                <el-form label-position="right" label-width="70px">
                  ...
                  >
                    ...
                    <el-checkbox
                      @change="editChange('isSelectCreate')"
                      v-model="attribute.isSelectCreate"
                      class="edit"
                      label="不可编辑"></el-checkbox>
                  </el-form-item>
                </el-form>
              ...
              <div v-else-if="indexIn === 'isSelectRemote'">
                <el-form label-position="right" label-width="70px">
                  ...
                  >
                    ...
                    <el-checkbox
                      @change="editChange('isSelectRemote')"
                      v-model="attribute.isSelectRemote"
                      class="edit"
                      label="不可编辑"></el-checkbox>
                  </el-form-item>
                  <el-form-item
                  ...
                  >
                    ...
                    <el-checkbox
                      @change="editChange('selectLoadingText')"
                      v-model="attribute.selectLoadingText"
                      class="edit"
                      label="不可编辑"></el-checkbox>
                  </el-form-item>
                  <el-form-item
                  ...
                  >
                    ...
                    <el-checkbox
                      @change="editChange('noMatchText')"
                      v-model="attribute.noMatchText"
                      class="edit"
                      label="不可编辑"></el-checkbox>
                  </el-form-item>
                  <el-form-item
                  ...
                  >
                    ...
                    <el-checkbox
                      @change="editChange('noDataText')"
                      v-model="attribute.noDataText"
                      class="edit"
                      label="不可编辑"></el-checkbox>
                  </el-form-item>
                </el-form>
              ...
              <div v-else-if="indexIn === 'switchStatus'">
                <el-form label-position="right" label-width="86px">
                  ...
                  >
                    ...
                    <el-checkbox
                      @change="editChange('addSwitchValue')"
                      v-model="attribute.addSwitchValue"
                      class="edit"
                      label="不可编辑"></el-checkbox>
                  </el-form-item>
                  <div v-if="itemIn">
                    <div v-if="addSwitchValue">
                      ...
                      >
                        ...
                        <el-checkbox
                          @change="editChange('onSwitchValue')"
                          v-model="attribute.onSwitchValue"
                          class="edit"
                          label="不可编辑"></el-checkbox>
                      </el-form-item>
                      <el-form-item
                      ...
                      >
                        ...
                        <el-checkbox
                          @change="editChange('showSwitchTooltip')"
                          v-model="attribute.showSwitchTooltip"
                          class="edit"
                          label="不可编辑"></el-checkbox>
                      </el-form-item>
                    </div>
                    ...
                    >
                      ...
                      <el-checkbox
                        @change="editChange('onText')"
                        v-model="attribute.onText"
                        class="edit"
                        label="不可编辑"></el-checkbox>
                    </el-form-item>
                    <el-form-item
                    ...
                    >
                      ...
                      <el-checkbox
                        @change="editChange('onFillColor')"
                        v-model="attribute.onFillColor"
                        class="edit"
                        label="不可编辑"></el-checkbox>
                    </el-form-item>
                  </div>
                  <div v-else>
                    <div v-if="addSwitchValue">
                      ...
                      >
                        ...
                        <el-checkbox
                          @change="editChange('offSwitchValue')"
                          v-model="attribute.offSwitchValue"
                          class="edit"
                          label="不可编辑"></el-checkbox>
                      </el-form-item>
                      <el-form-item
                    ...
                    >
                      ...
                      <el-checkbox
                        @change="editChange('offText')"
                        v-model="attribute.offText"
                        class="edit"
                        label="不可编辑"></el-checkbox>
                    </el-form-item>
                    <el-form-item
                    ...
                    >
                      ...
                      <el-checkbox
                        @change="editChange('offFillColor')"
                        v-model="attribute.offFillColor"
                        class="edit"
                        label="不可编辑"></el-checkbox>
                    </el-form-item>
                  </div>
              ...
              <div v-else-if="indexIn === 'sliderStep'">
                <el-form label-position="right" label-width="86px" :model="config[index]" :rules="rulesSlider">
                  ...
                  >
                    ...
                    <el-checkbox
                      @change="editChange('sliderStep')"
                      v-model="attribute.sliderStep"
                      class="edit"
                      label="不可编辑"></el-checkbox>
                  </el-form-item>
                  <el-form-item
                  ...
                  >
                    ...
                    <el-checkbox
                      @change="editChange('sliderHeight')"
                      v-model="attribute.sliderHeight"
                      class="edit"
                      label="不可编辑"></el-checkbox>
                  </el-form-item>
                </el-form>
              ...
              <div v-else-if="indexIn === 'sliderRange'">
                <el-form label-position="right" label-width="86px">
                  ...
                  >
                    ...
                    <el-checkbox
                      @change="editChange('sliderRange')"
                      v-model="attribute.sliderRange"
                      class="edit"
                      label="不可编辑"></el-checkbox>
                  </el-form-item>
                  <div v-if="!config[index].sliderRange">
                    ...
                    >
                      ...
                      <el-checkbox
                        @change="editChange('sliderShowInput')"
                        v-model="attribute.sliderShowInput"
                        class="edit"
                        label="不可编辑"></el-checkbox>
                    </el-form-item>
                  </div>
                  <div v-if="config[index].sliderShowInput">
                    ...
                    >
                      ...
                      <el-checkbox
                        @change="editChange('sliderShowInputButton')"
                        v-model="attribute.sliderShowInputButton"
                        class="edit"
                        label="不可编辑"></el-checkbox>
                    </el-form-item>
                  </div>
              ...
              <div v-else-if="indexIn === 'sliderShowStops'">
                <el-form label-position="right" label-width="86px">
                  ...
                  >
                    ...
                    <el-checkbox
                      @change="editChange('sliderShowStops')"
                      v-model="attribute.sliderShowStops"
                      class="edit"
                      label="不可编辑"></el-checkbox>
                  </el-form-item>
                </el-form>
              ...
              <div v-else-if="indexIn === 'sliderShowTooltip'">
                <el-form label-position="right" label-width="70px">
                  ...
                  >
                    ...
                    <el-checkbox
                      @change="editChange('sliderShowTooltip')"
                      v-model="attribute.sliderShowTooltip"
                      class="edit"
                      label="不可编辑"></el-checkbox>
                  </el-form-item>
                </el-form>
              ...
              <div v-else-if="indexIn === 'typeModel' && itemIn === 'time'">
                <el-form label-position="right" label-width="84px">
                  ...
                  >
                    ...
                    <el-checkbox
                      @change="editChange('timeFixed')"
                      v-model="attribute.timeFixed"
                      class="edit"
                      label="不可编辑"></el-checkbox>
                  </el-form-item>
                  <div v-if="config[index].timeFixed">
                    ...
                    >
                      ...
                      <el-checkbox
                        @change="editChange('startTime')"
                        v-model="attribute.startTime"
                        class="edit"
                        label="不可编辑"></el-checkbox>
                    </el-form-item>
                    <el-form-item
                    ...
                    >
                      ...
                      <el-checkbox
                        @change="editChange('stepTime')"
                        v-model="attribute.stepTime"
                        class="edit"
                        label="不可编辑"></el-checkbox>
                    </el-form-item>
                    <el-form-item
                    ...
                    >
                      <el-time-picker
                        ...
                        placeholder="请输入间隔时间"></el-time-picker>
                      <el-checkbox
                        @change="editChange('endTime')"
                        v-model="attribute.endTime"
                        class="edit"
                        label="不可编辑"></el-checkbox>
                    </el-form-item>
                  </div>
                  <div v-if="!config[index].timeFixed">
                    ...
                    >
                      <el-time-picker
                        ...
                        <el-checkbox
                          @change="editChange('timeSelectableRange')"
                          v-model="attribute.timeSelectableRange"
                          class="edit"
                          label="不可编辑"></el-checkbox>
                    </el-form-item>
                  </div>
                  ...
                  <div>
                    <el-form label-position="right" label-width="112px">
                      ...
                      >
                        ...
                        <el-checkbox
                          @change="editChange('isRangeSelect')"
                          v-model="attribute.isRangeSelect"
                          class="edit"
                          label="不可编辑"></el-checkbox>
                      </el-form-item>
                    </el-form>
                ...
                <el-form label-position="right" label-width="70px">
                  <div v-if="config[index].dateTypeModel === 'date' ||
                    ...
                    >
                      ...
                      <el-checkbox
                        @change="editChange('isHasShortcut')"
                        v-model="attribute.isHasShortcut"
                        class="edit"
                        label="不可编辑"></el-checkbox>
                    </el-form-item>
                  </div>
                  ...
                  >
                    ...
                    <el-checkbox
                      @change="editChange('dateTypeModel')"
                      v-model="attribute.dateTypeModel"
                      class="edit"
                      label="不可编辑"></el-checkbox>
                  </el-form-item>
                  <el-form-item
                  ...
                  >
                    ...
                    <el-checkbox
                      @change="editChange('formatDate')"
                      v-model="attribute.formatDate"
                      class="edit"
                      label="不可编辑"></el-checkbox>
                  </el-form-item>
                  <div
                    ...
                    >
                      ...
                      <el-checkbox
                        @change="editChange('rangeSeparator')"
                        v-model="attribute.rangeSeparator"
                        class="edit"
                        label="不可编辑"></el-checkbox>
                    </el-form-item>
                  </div>
              ...
              <div v-else-if="indexIn === 'timeEditable' && !config[index].timeFixed">
                <el-form label-position="right" label-width="130px">
                  ...
                  >
                    ...
                    <el-checkbox
                      @change="editChange('timeEditable')"
                      v-model="attribute.timeEditable"
                      class="edit"
                      label="不可编辑"></el-checkbox>
                  </el-form-item>
                </el-form>
                ...
                <el-form label-position="right" label-width="130px">
                  ...
                  >
                    <div v-if="config[index].rangeOfFixedEnd">
                      ...
                      <el-checkbox
                        @change="editChange('isShowClearableend')"
                        v-model="attribute.isShowClearableend"
                        class="edit"
                        label="不可编辑"></el-checkbox>
                    </div>
                    <div v-else>
                      ...
                      <el-checkbox
                        @change="editChange('isShowClearable')"
                        v-model="attribute.isShowClearable"
                        class="edit"
                        label="不可编辑"></el-checkbox>
                    </div>
                  </el-form-item>
              ...
              <div v-else-if="indexIn === 'width' && config.CName === 'CSwitch'">
                <el-form label-position="right" label-width="70px">
                  ...
                  >
                    ...
                    <el-checkbox
                      @change="editChange('switchWidth')"
                      v-model="attribute.switchWidth"
                      class="edit"
                      label="不可编辑"></el-checkbox>
                  </el-form-item>
                </el-form>
              ...
              <div v-else-if="indexIn === 'defaultTagName'">
                <el-form label-position="right" label-width="70px">
                  ...
                  >
                    ...
                    <el-checkbox
                      @change="editChange('defaultTagName')"
                      v-model="attribute.defaultTagName"
                      class="edit"
                      label="不可编辑"></el-checkbox>
                  </el-form-item>
                </el-form>
              ...
              <div v-else-if="indexIn === 'closable'">
                <el-form label-position="right" label-width="90px">
                  ...
                  >
                    ...
                    <el-checkbox
                      @change="editChange('closable')"
                      v-model="attribute.closable"
                      class="edit"
                      label="不可编辑"></el-checkbox>
                  </el-form-item>
                </el-form>
              ...
              <div v-else-if="indexIn === 'hit'">
                <el-form label-position="right" label-width="70px">
                  ...
                  >
                    ...
                    <el-checkbox
                      @change="editChange('hit')"
                      v-model="attribute.hit"
                      class="edit"
                      label="不可编辑"></el-checkbox>
                  </el-form-item>
                </el-form>
                ...
                <div class="block">
                  <el-form label-position="right" label-width="70px">
                    ...
                    >
                      ...
                      <el-checkbox
                        @change="editChange('colorTag')"
                        v-model="attribute.colorTag"
                        class="edit"
                        label="不可编辑"></el-checkbox>
                    </el-form-item>
                  </el-form>
              ...
              <div v-else-if="indexIn === 'showText'">
                <el-form label-position="right" label-width="100px" class="left">
                  ...
                  >
                    ...
                    <el-checkbox
                      @change="editChange('showTextStatus')"
                      v-model="attribute.showTextStatus"
                      class="edit"
                      label="不可编辑"></el-checkbox>
                  </el-form-item>
                  <div v-if="config[index][indexIn].showTextStatus && config[index].typeModel === 'line'">
                    ...
                    >
                      ...
                      <el-checkbox
                        @change="editChange('textInsideStatus')"
                        v-model="attribute.textInsideStatus"
                        class="edit"
                        label="不可编辑"></el-checkbox>
                    </el-form-item>
                  </div>
                  <div v-if="config[index].typeModel === 'circle'">
                    ...
                    >
                      ...
                      <el-checkbox
                        @change="editChange('circleWidth')"
                        v-model="attribute.circleWidth"
                        class="edit"
                        label="不可编辑"></el-checkbox>
                    </el-form-item>
                  </div>
                  ...
                  >
                    ...
                    <el-checkbox
                      @change="editChange('strokeWidth')"
                      v-model="attribute.strokeWidth"
                      class="edit"
                      label="不可编辑"></el-checkbox>
                  </el-form-item>
                </el-form>
                ...
                <el-form label-position="right" label-width="70px">
                    <div v-if="config[index].typeModel === 'string' && !config[index].isDot.dotStatus">
                      ...
                      >
                        ...
                        <el-checkbox
                          @change="editChange('stringDefaultValue')"
                          v-model="attribute.stringDefaultValue"
                          class="edit"
                          label="不可编辑"></el-checkbox>
                      </el-form-item>
                    </div>
                    <div v-if="config[index].typeModel === 'number' && !config[index].isDot.dotStatus">
                      ...
                      >
                        ...
                        <el-checkbox
                          @change="editChange('numberDefaultValue')"
                          v-model="attribute.numberDefaultValue"
                          class="edit"
                          label="不可编辑"></el-checkbox>
                      </el-form-item>
                      <el-form-item
              ...
              <div v-else-if="indexIn === 'isDot'">
                <el-form label-position="right" label-width="70px">
                  ...
                  >
                    ...
                    <el-checkbox
                      @change="editChange('isDot')"
                      v-model="attribute.isDot"
                      class="edit"
                      label="不可编辑"></el-checkbox>
                  </el-form-item>
                </el-form>
              ...
              <div v-else-if="indexIn === 'badgeStatus'">
                <el-form label-position="right" label-width="70px">
                  ...
                  >
                    ...
                    <el-checkbox
                      @change="editChange('badgeStatus')"
                      v-model="attribute.badgeStatus"
                      class="edit"
                      label="不可编辑"></el-checkbox>
                  </el-form-item>
                </el-form>
              ...
              <div v-else-if="indexIn === 'trigger'">
                <el-form label-position="right" label-width="70px">
                  ...
                  >
                    ...
                    <el-checkbox
                      @change="editChange('triggerModel')"
                      v-model="attribute.triggerModel"
                      class="edit"
                      label="不可编辑"></el-checkbox>
                  </el-form-item>
                </el-form>
                ...
                <el-form label-position="right" label-width="70px">
                  ...
                  >
                    <el-input type="textarea"
                              ...
                              v-model="config[index][indexIn]"></el-input>
                    <el-checkbox
                      @change="editChange('content')"
                      v-model="attribute.content"
                      class="edit"
                      label="不可编辑"></el-checkbox>
                  </el-form-item>
                </el-form>
              ...
              <div v-else-if="indexIn === 'visibleArrow'"> <!--Popover弹出框的visibleArrow属性-->
                <el-form label-position="right" label-width="138px">
                  ...
                  >
                    ...
                    <el-checkbox
                      @change="editChange('visibleArrow')"
                      v-model="attribute.visibleArrow"
                      class="edit"
                      label="不可编辑"></el-checkbox>
                  </el-form-item>
                </el-form>
              ...
              <div v-else-if="indexIn === 'offset'"> <!--Popover弹出框的offset属性-->
                <el-form label-position="right" label-width="70px">
                  ...
                  >
                    ...
                    <el-checkbox
                      @change="editChange('offset')"
                      v-model="attribute.offset"
                      class="edit"
                      label="不可编辑"></el-checkbox>
                  </el-form-item>
                </el-form>
              ...
              <div v-else-if="indexIn === 'placement'"> <!--Popover弹出框的位置属性-->
                <el-form label-position="top" label-width="70px">
                  ...
                  >
                    ...
                    <el-checkbox
                      @change="editChange('placement')"
                      v-model="attribute.placement"
                      class="editPlacement"
                      label="不可编辑"></el-checkbox>
                  </el-form-item>
                </el-form>
                ...
                <el-form label-position="right" label-width="70px">
                  ...
                  >
                    <el-input @change="changeConfig()" placeholder="控件默认值"
                              v-model="config[index][indexIn]"></el-input>
                    <el-checkbox
                      @change="editChange('CKey')"
                      v-model="attribute.CKey"
                      class="edit"
                      label="不可编辑"></el-checkbox>
                  </el-form-item>
                </el-form>
          ...
          <div v-else-if="index === 'CValidate'">
            <el-form label-position="right" label-width="70px">
              ...
              <el-checkbox @change="validateStatusChange(item)" v-model="item.status"></el-checkbox>
                <el-checkbox
                  @change="editChange('CValidate')"
                  v-model="attribute.CValidate"
                  class="edit"
                  label="不可编辑"></el-checkbox>
              </el-form-item>
              <div v-if="item.status">
          ...
          <div v-else-if="index === 'CLayout'">
            <el-form label-position="top" label-width="70px">
              <el-form-item class="lineRow" label="布局">
                ...
                <el-checkbox
                  @change="editChange('CLayout')"
                  v-model="attribute.CLayout"
                  class="edit"
                  label="不可编辑"></el-checkbox>
              </el-form-item>
              ...
              <el-form-item class="lineRow">
                <div v-if="config.layoutModel==='percentLayout' && config.currentLayout">
                  ...
                  ></el-input>
                  <el-checkbox
                    @change="editChange('percentLayout')"
                    v-model="attribute.percentLayout"
                    class="edit"
                    label="不可编辑"></el-checkbox>
                </div>
                <div v-else-if="config.layoutModel==='pixelLayout' && config.currentLayout">
                  ...
                  ></el-input>
                  <el-checkbox
                    @change="editChange('pixelLayout')"
                    v-model="attribute.pixelLayout"
                    class="edit"
                    label="不可编辑"></el-checkbox>
                </div>
                <div v-else-if="config.layoutModel==='flexLayout' && config.currentLayout">
                  ...
                  ></el-input>
                  <el-checkbox
                    @change="editChange('flexLayout')"
                    v-model="attribute.flexLayout"
                    class="edit"
                    label="不可编辑"></el-checkbox>
                </div>
                <div v-else-if="config.layoutModel==='columnLayout' && config.currentLayout">
                  ...
                  ></el-input>
                  <el-checkbox
                    @change="editChange('columnLayout')"
                    v-model="attribute.columnLayout"
                    class="edit"
                    label="不可编辑"></el-checkbox>
                </div>
              </el-form-item>
    ...
    data () {
      return {
        ...
        attribute: {
          ...
          type: false,
          size: false,
          currentSelectedShowcontent: false,
          currentSelectedLabel: false,
          delete: false,
          isDisabled: false,
          textColor: false,
          fillColor: false,
          ...
          ableSelectedMin: false,
          ableSelectedMax: false,
          // CSelect
          isMultiple: false,
          ...
          currentSelectedGroupLabel: false,
          currentSelectedGroupShowcontent: false,
          DeleteSelectGroup: false,
          isDisabledGroup: false,
          selectLoadingText: false,
          noMatchText: false,
          noDataText: false,
          // CCollapse
          ...
          numberDefaultValue: false,
          max: false,
          badgeStatus: false,
          // CCascader
          cascadePropsTitle: false,
          showAllLevels: false,
          filterableOption: false,
          changeOnSelectOption: false,
          cascadeSizeOption: false,
          cascadePlaceholder: false,
          // CDateTimePicker
          // time
          timeEditable: false,
          isShowClearable: false,
          isShowClearableend: false,
          timeFixed: false,
          startTime: false,
          stepTime: false,
          endTime: false,
          isRangeSelect: false,
          timeSelectableRange: false,
          // date
          isHasShortcut: false,
          dateTypeModel: false,
          formatDate: false,
          rangeSeparator: false,
          // loading
          loadingText: false,
          // page
          pageSmall: false,
          ...
          sliderShowInputButton: false,
          sliderShowStops: false,
          sliderShowTooltip: false,
          addSwitchValue: false,
          onSwitchValue: false,
          showSwitchTooltip: false,
          offSwitchValue: false,
          onText: false,
          onFillColor: false,
          offText: false,
          offFillColor: false,
...
//          radio和checkbox label值校验
    ...
    created () {
      ...
      if (deleteArr) {
        ...
        let attr = deleteArr[key]
        if (attr) {
          for (let item in this.attribute) {
            if (attr.indexOf(item) !== -1) {
              this.attribute[item] = true
            }
          }
        }
      }
    ...
    watch: {
      ...
      config () {
        this.attribute = this.L.cloneDeep(this.initAttribute)
        let deleteArr = JSON.parse(localStorage.getItem('deleteAttribute'))
        if (deleteArr) {
          let key = this.config.CName
          let attr = deleteArr[key]
